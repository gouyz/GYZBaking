...
- (void)createItem:(NSString *)item {
    ...
    UIButton *buttonItem = [[UIButton alloc] initWithFrame:CGRectMake(self.maxWidth, 7, itemWidth, 30)];
    ...
    ViewBorder(buttonItem, self.zk_itemDefaultColor, 0.5);
    ViewRadius(buttonItem, 5);
...
- (void)itemClick:(id)sender {
    ...
    if (self.buttonSelected != button) {
        ...
        ViewBorder(self.buttonSelected, self.zk_itemDefaultColor, 0.5);
        self.buttonSelected.backgroundColor = [UIColor whiteColor];
        
        [button setTitleColor:[UIColor whiteColor] forState:0];
        ViewBorder(button, self.zk_itemSelectedColor, 0.5);
        button.backgroundColor = self.zk_itemSelectedColor;
